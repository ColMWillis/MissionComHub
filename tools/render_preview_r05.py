...
root = repo / "CAD/STL/R0.5"
fig = plt.figure(figsize=(18, 7), dpi=120, facecolor="#f1f3f6")
items = [
    ("MCH-MkI_body_R0.5.stl", 28, -45, "Body: controls and interior"),
    ("MCH-MkI_body_R0.5.stl", 28, 45, "Body: I/O and interior"),
    ("MCH-MkI_lid_R0.5.stl", 72, -90, "Branded locating-lip lid"),
]
...
fig.tight_layout()
out = repo / "images/R0.5_preview.png"
