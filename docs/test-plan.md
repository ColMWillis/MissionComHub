...
| T-A-005 | Measure body mesh | 146 × 96 × 103 mm within 0.02 mm | Pass |
...
| Test ID | Method | Pass criterion |
|---|---|---|
| T-M-001 | Measure printed body | Within printer-calibrated tolerance of 146 × 96 × 103 mm |
...
| T-M-008 | Fit switch with unfused busbar installed | Switch body and terminals remain clear through full insertion and wiring |
