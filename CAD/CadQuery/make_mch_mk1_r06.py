...
REV = 'R0.6'
OUT = Path(__file__).resolve().parent / 'MissionComHub_MkI_Enclosure_R0.6'
...
parts={
 'MCH-MkI_body_R0.6':body,
 'MCH-MkI_lid_R0.6':lid,
 'MCH-MkI_peplink_strain_relief_R0.6':clamp,
 'MCH-MkI_control_fit_coupon_R0.6':control_coupon,
 'MCH-MkI_AAOTOKK_USB-C_fit_coupon_R0.6':usb_coupon,
 'MCH-MkI_wire_exit_fit_coupon_R0.6':wire_coupon,
}
...
shutil.copy(Path(__file__).resolve(),OUT/'make_mch_mk1_r06.py')
(OUT/'dimensions.json').write_text(json.dumps(manifest,indent=2))

readme=f'''# Mission Communications Hub Mk I Enclosure R0.6
