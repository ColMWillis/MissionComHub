...
REV = 'R0.9'
OUT = Path(__file__).resolve().parent / 'MissionComHub_MkI_Enclosure_R0.9'
...
parts={
 'MCH-MkI_body_R0.9':body,
 'MCH-MkI_lid_R0.9':lid,
 'MCH-MkI_peplink_strain_relief_R0.9':clamp,
 'MCH-MkI_control_fit_coupon_R0.9':control_coupon,
 'MCH-MkI_USB-C_final_fit_coupon_R0.9':usb_coupon,
 'MCH-MkI_wire_exit_fit_coupon_R0.9':wire_coupon,
 'MCH-MkI_BlueSea5045_fused_block_riser_coupon_R0.9':fused_block_coupon,
 'MCH-MkI_unfused_busbar_riser_coupon_R0.9':unfused_block_coupon,
}
...
shutil.copy(Path(__file__).resolve(),OUT/'make_mch_mk1_r09.py')
(OUT/'dimensions.json').write_text(json.dumps(manifest,indent=2))

readme=f'''# Mission Communications Hub Mk I Enclosure R0.9 Final Draft
